        ...
        <div className="w-full max-w-md p-8 bg-white border border-gray-200 shadow-2xl dark:bg-gray-800 rounded-2xl dark:border-gray-700">
          ...
          <form className="space-y-4">
            ...
            <div className="flex items-start space-x-2">
              <input type="checkbox" className="mt-1 rounded text-cyan-600 focus:ring-cyan-500" />
              <span className="text-sm text-gray-600 dark:text-gray-400">
                I agree to the{" "}
                <a href="#" className="text-cyan-600 hover:text-cyan-700 hover:underline dark:text-cyan-400">
                  Terms of Service
                </a>{" "}
                and{" "}
                <a href="#" className="text-cyan-600 hover:text-cyan-700 hover:underline dark:text-cyan-400">
            ...
            <button
              type="submit"
              className="w-full py-2.5 font-semibold text-white transition duration-200 bg-gradient-to-r from-cyan-200 to-cyan-600 rounded-lg hover:from-cyan-700 hover:to-cyan-800 shadow-md hover:shadow-lg"
            >
              Sign Up
            </button>
          </form>
