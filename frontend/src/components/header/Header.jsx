    ...
    <header className="relative text-white bg-gradient-to-t from-cyan-700 to-cyan-200 ">
      ...
      <div className="px-4 py-20 mx-auto max-w-7xl sm:py-28 lg:py-32">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-6xl font-extrabold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">
            Welcome to BizOra
          </h1>
          <p className="mt-4 text-lg font-medium text-gray-950 ">
            Your AI-powered business analytics platform. Visualize key metrics,
            gain actionable insights, and make smarter, data-driven decisions
            all in one place.
          </p>
