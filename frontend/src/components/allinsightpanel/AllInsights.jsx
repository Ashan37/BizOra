...
const insightsData = [
  {
    ...
    description:
      "Strong performance driven by Product A and B campaigns across EMEA region.",
    category: "Sales",
    priority: "high",
    date: "2025-10-05",
  ...
  },
  {
    ...
    description:
      "Market analysis indicates 18% TAM expansion in Q4 if positioned correctly.",
    category: "Product",
    priority: "medium",
    date: "2025-10-04",
  ...
  },
  {
    ...
    description:
      "Improved onboarding flow and customer success initiatives reduced early churn.",
  ...
  },
  {
    ...
    description:
      "Spike correlated with recent product release; team monitoring resolution time.",
    category: "Support",
    priority: "medium",
    date: "2025-10-02",
    tags: ["support", "volume"],
  ...
  },
  {
    ...
    description:
      "Optimized ad spend and A/B testing drove higher conversion rates.",
    category: "Marketing",
    priority: "low",
    date: "2025-09-30",
    tags: ["ROI", "conversion"],
  ...
  },
  {
    ...
    description:
      "Cloud resource usage increasing; recommend cost optimization review.",
    category: "Operations",
    priority: "medium",
    date: "2025-10-01",
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Actionable intelligence derived from your business data
          </p>
        </div>
