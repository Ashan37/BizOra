        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <div className="hidden sm:flex sm:items-center sm:space-x-4">
              ...
              <a href="#signup" className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-md hover:bg-indigo-700">Sign up</a>
            </div>
      ...
      <div className={`${open ? 'block' : 'hidden'} sm:hidden`} id="mobile-menu">
        ...
        <div className="pt-4 pb-3 border-t border-gray-200">
          <div className="px-4 space-y-1">
            ...
            <a href="#signup" className="block px-3 py-2 text-base font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700">Sign up</a>
          </div>
        </div>
      </div>
    </header>
