    ...
    <header className="w-full bg-transparent shadow">
      <div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        <div className="flex items-center">
          ...
          <nav
            aria-label="Primary"
            className="hidden sm:ml-8 sm:flex sm:space-x-6 sm:items-center"
          >
            <a
              href="/"
              className="px-3 py-2 text-sm font-medium text-gray-900 border-b-2 border-indigo-500"
            >
              Home
            </a>
            <a
        ...
        <div className="flex items-center">
          <div className="hidden sm:flex sm:items-center sm:space-x-4">
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2 text-sm font-medium text-white border border-transparent rounded-md bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:opacity-90"
            >
              Sign up
            </button>
          </div>
      ...
      >
        <div className="px-2 pt-2 pb-3 space-y-1">
          <a
            href="#"
            className="block px-3 py-2 text-base font-medium text-indigo-700 rounded-md bg-indigo-50"
          >
            Home
          </a>
          <a
        ...
        <div className="pt-4 pb-3 border-t border-gray-200">
          <div className="px-4 space-y-1">
            ...
            <button
              type="button"
              onClick={() => (window.location.href = '/signup')}
              className="block w-full px-3 py-2 text-base font-medium text-left text-white rounded-md bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:opacity-90"
            >
              Sign up
            </button>
          </div>
